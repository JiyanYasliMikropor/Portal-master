...
namespace Mikroportal.API.Services.ACS
{
    public class ReplacementService :IReplacementService
    {
        ...
        public ReplacementService(IConfiguration configuration, IMikroportalUOW mikroportalContext, IHostingEnvironment hostingEnvironment, SpDataContext dbContext, IHttpContextAccessor iHttpContextAccessor)
        {
