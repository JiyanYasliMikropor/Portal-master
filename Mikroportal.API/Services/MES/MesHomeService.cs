...
namespace Mikroportal.API.Services.MES
{
    public class MesHomeService : IMesHomeService
    {
        ...
        public MesHomeService(IConfiguration configuration, IMikroportalUOW mikroportalContext)
        {
        ...
        public GetDashboardMenuResponse GetDashboardMenu(int UserId)
        {
            ...
            var userMenu = from menuItem in context.TblMenuItemsRepository.Get()
                           ...
                           where menuItem.MenuValueForProjects == "Mes" && userMenuItems.UserId == UserId
                           select new
                           {
