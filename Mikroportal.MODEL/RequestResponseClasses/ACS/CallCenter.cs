...
namespace Mikroportal.MODEL.RequestResponseClasses.ACS
{
    ...
    public class CallCenterView
    {
        ...
        public string CallCenteRelatedPersonPhonerComment { get; set; }
        public string FileNames { get; set; }
        public List<IFormFile> files { get; set; }

    }

    public class GetCallCenterListResponse : ResponseBase
    {
    ...
    public class TblSshMachineryServicesResponse : ResponseBase
    {
